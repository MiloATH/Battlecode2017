...
public strictfp class RobotPlayer {
    ...
    //3:Soldier
    //4:Tank
    static int[] build = {0, 2, 2, 0, 0, 2, 0, 0, 0, 3, 0, 0, 0, 3};
    ...
    */
    ...
    public static Direction navigateTo(MapLocation loc) throws GameActionException {
    ...
    public static void moveTowardsEnemyArchonInitial() throws GameActionException{
